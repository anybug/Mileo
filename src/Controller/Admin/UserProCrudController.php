...
class UserProCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle(Crud::PAGE_INDEX, 'Pro users');
    }
    ...
    public function createIndexQueryBuilder(
        ...
        return parent::createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters)
            ...
            ->setParameter('planCode', PlanCode::PRO);
    }
    ...
    public function persistEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        $proPlan = $this->planRepository->findByCode(PlanCode::PRO);

        if (null === $proPlan) {
            throw new \LogicException('The PRO plan could not be found.');
        }
